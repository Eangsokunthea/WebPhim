...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{asset('/home')}}" class="brand-link">
      ...
      <img src="{{asset('uploads/logo/'.$info->logo)}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">WEB XEM PHIM</span>
    </a>
