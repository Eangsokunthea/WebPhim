...
<script type="text/javascript">
    $('.comment_duyet_btn').click(function(){
        ...
        var comment_movie_id = $(this).attr('id');
        ...
        $.ajax({
            ...
            data:{comment_status:comment_status,comment_id:comment_id,comment_movie_id:comment_movie_id},
            success:function(data){
                location.reload();
    ...
    $('.btn-reply-comment').click(function(){
        ...
        var comment_movie_id = $(this).data('movie_id');
          ...
          $.ajax({
                ...
                data:{comment:comment,comment_id:comment_id,comment_movie_id:comment_movie_id},
                success:function(data){
